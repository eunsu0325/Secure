# coconut/data_stream.py
"""Experience stream management for COCONUT continual learning"""
...
class ExperienceStream:
    """Data stream manager for COCONUT continual learning framework."""
    ...
    def __init__(self,
                 ...
                 base_id: int = 10000):
        """
        Initialize experience stream for continual learning.

        Args:
            train_file: Path to training data file
            negative_file: Path to negative samples file
            num_negative_classes: Number of negative classes to use (-1 for all)
            base_id: Base ID for negative class indexing
        """
        ...
        print(f"Using BASE_ID: {self.base_id}")
